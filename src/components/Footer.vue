    ...
    <div class="flex w-full justify-between text-sm leading-tight lg:justify-start lg:leading-relaxed lg:pl-0">
      <div class="lg:pr-8">
        ...
        <ul class="text-grey-light leading-normal">
          ...
          <li>Jobs</li>
          <li><a href="https://www.calculator.net/">Calculators</a></li>
      ...
      <div class="lg:px-8">
        ...
        <ul class="text-grey-light leading-normal">
          ...
          <li><a href="/ForgotPassword">Reset password</a></li>
          <li>Settings</li>
          <li>Splitwise Pro</li>
            <li><span class="translation_missing" title="translation missing: en.splitwise_pay">Splitwise Pay</span></li>
        </ul>
      </div>
      <div class="hidden lg:block border-r border-grey-lightest h-30"></div>
      <div class="lg:pl-8">
        ...
        <ul class="text-grey-light leading-normal">
          <li><a href="/Contactsupport">Contact us</a></li>
...
.text-left, body.terms main table td, body.terms main table th, body.admin table th, body.admin table td {
    text-align: left;
}
.px-8, body.terms main {
    padding-left: 2rem;
    padding-right: 2rem;
}
.mx-auto, body.terms main, #admin-header-menu {
    margin-left: auto;
    margin-right: auto;
}

.container, body.terms main {
    max-width: 1280px;
}
.container, body.terms main {
    width: 100%;
...
.w-full, body.login div.modal_box input[type="text"], body.login div.modal_box input[type="email"], body.login div.modal_box input[type="password"], body.admin textarea:not(.inline), body.admin input[type="text"]:not(.inline), body.admin select:not(.inline) {
    width: 100%;
}
...
.leading-normal,body.terms main {
    line-height: 1.5;
}
.ul {
    list-style: none;
...
.border-grey-lightest, body.login div.modal_box input[type="text"], body.login div.modal_box input[type="email"], body.login div.modal_box input[type="password"], body.login div.modal_box, body.admin textarea, body.admin input[type="text"], body.admin select {
    border-color: #E6E8EE;
}
.lg\:block {
    display: block;
...
.inline-block,body.admin .admin-cta-button,body.admin input[type="submit"] {
